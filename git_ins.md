...
git pull
```
## 17. Pull request - что это и для чего оно нужно?
![Что это такое?](pullRe.png)

Мы разобрались с тем, как склонировать чужой проект к нам на компьютер и работать с ним, но что делать, если мы хотим поделиться нашими изменениями с самим автором и узнать, что он думает?
Эту ситуацию Git и GitHub тоже предусмотрели. 

В больших компаниях один ответственный за проект создает аккаунт. Другие пользователи дают команду **`pull request`**. Предлагать изменения на GitHub нужно в отдельной ветке. Сначала пользователь копирует репозиторий на свой компьютер, делает fork репозитория, затем клонирует версию на своём ПК, создаёт ветку с предлагаемыми изменениями, отправляет изменения командой push в свой аккаунт на GitHub и даёт команду pull request.
 
 ## **`Как сделать pull request?`**
 1. Делаем *fork* (ответвление) интересующего репозитория.
 2. Делаем *git clone* **СВОЕЙ** версии репозитория.
 3. Создаем новую ветку и в НЕЕ вносим свои изменения - *git branch new_nranch_name*.
 4. Фиксируем изменения (делаем коммиты) - *git commit*.
 5. Отправляем свою версию в свой GitHub - *git push*.
 6. На сайте GitHub нажимаем кнопку *`pull request`*.

![Pull request](pullReq.jpg)

### Всё! Отправили нашу версию проекта автору и ожидаем!)
Автор может принять вашу версию и слить ее с основной веткой или же отправить свое мнение на этот счет.

# На этом, на данный момент, наша инструкция подходит к своему логическому завершению! До новых встреч, как говорится!)
![Подошли к концу](%D0%9A%D0%BE%D0%BD%D0%B5%D1%86.jpg)