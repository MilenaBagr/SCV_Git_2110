...
Для того, чтобы клонировать чужой репозиторий - регистрироваться необязательно, но если мы хотим делиться нашими изменениями или какими-либо проектами, то без регистрации на GitHub не обойтись!
